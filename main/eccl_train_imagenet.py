...
parser = argparse.ArgumentParser(description='ECCL IMAGENET-LT Training')
parser.add_argument('--cfg_name', default='ECCL IMAGENET-LT', help='name of this configuration')
